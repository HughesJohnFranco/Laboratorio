...
class Mano:
    ...
    def __init__(self, mode=False, max_manos=2, conf_deteccion=0.7, conf_segui=0.6):
        self.mode = mode
            ...
            for mano in self.resultados.multi_hand_landmarks:
                if dibujar:
                    ...
                    self.dibujo.draw_landmarks(
                        ...
                        self.dibujo.DrawingSpec(color=(0,0,0), thickness=1), #circle_radius=1, opcional estetuca
                        self.dibujo.DrawingSpec(color=(200,0,0), thickness=2)
                    )
        return frame
